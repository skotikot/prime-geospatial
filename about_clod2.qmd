...
<h1>Science for Changing Landscapes</h1>

<h2>We deliver data-driven intelligence where it matters most.</h2>
...
<div id="eg-ea-map" class="eg-position-map-interactive"></div>

<script src="https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.9.4/leaflet.min.js"></script>
<script>
document.addEventListener("DOMContentLoaded", function () {
  var map = L.map('eg-ea-map', { scrollWheelZoom: false }).setView([2.0, 38.0], 4);
