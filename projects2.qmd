...
::::::::::::::::::::::::::::::::::::::: eg-page
:::: {#hero .eg-hero .eg-hero-right .eg-hero-top style="--eg-hero-img:url('images/nrkGraze.jpg');"}
::: eg-wrap
<!--[About us]{.eg-eyebrow}-->
...
sites <- data.frame(
  name = c(
    "Habitat assessment",
    "Blue gam mapping",
    "LULC modeling and scenario planning",
...
leaflet(height = 460) %>%
  ...
  setView(lng = 35.87, lat = -1.15, zoom = 6) %>%
  addCircleMarkers(
    data = sites,
    lng = ~lng, lat = ~lat,
    color = ~color,
...
::: eg-proj-case-cta
[Learn more](land-use-modeling.qmd){.eg-btn .eg-btn-outline}
:::
:::::
